(function() {
	...
	documentoCtrl.$inject = ['$scope', '$mdDialog', 'ActualizarContenidoMaterialService', 'ObtenerContenidoMaterialService'];

	function documentoCtrl($scope, $mdDialog, ActualizarContenidoMaterialService, ObtenerContenidoMaterialService) {
